...
TABLES = [
    ...
    ("src/opus/celt/tables.uya", "CELT_PULSE_CACHE_INDEX50", 105, 433495822, 32768, None),
    ("src/opus/celt/tables.uya", "CELT_PULSE_CACHE_BITS50", 392, 822794778, 0, None),
    ("src/opus/celt/tables.uya", "CELT_PULSE_CACHE_CAPS50", 168, 474607814, 0, None),
