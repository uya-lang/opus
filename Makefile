...
TEST_SRCS := tests/scaffold_modules.uya tests/core_types.uya tests/core_constants.uya tests/core_errors.uya tests/core_qformat.uya tests/core_saturate.uya tests/core_bitops.uya tests/dsp_filters.uya tests/dsp_resampler.uya tests/dsp_pitch.uya tests/dsp_window.uya tests/dsp_mdct.uya tests/packet_toc.uya tests/entropy_range_dec.uya tests/entropy_range_enc.uya tests/celt_mode.uya tests/celt_rate.uya tests/celt_cwrs.uya tests/celt_bands.uya tests/celt_deemphasis.uya tests/celt_state.uya tests/celt_quant_bands.uya tests/celt_tf.uya tests/celt_spread.uya tests/celt_mdct_bridge.uya tests/celt_decode.uya tests/silk_state.uya tests/silk_decoder_control.uya tests/silk_frame_params.uya tests/silk_shell_coder.uya tests/silk_pulse_sign.uya tests/silk_nlsf.uya tests/silk_lpc.uya tests/silk_ltp.uya tests/silk_stereo.uya tools/check_tables.uya
SILK_TEST_SRCS := tests/silk_state.uya tests/silk_decoder_control.uya tests/silk_frame_params.uya tests/silk_shell_coder.uya tests/silk_pulse_sign.uya tests/silk_nlsf.uya tests/silk_lpc.uya tests/silk_ltp.uya tests/silk_stereo.uya
